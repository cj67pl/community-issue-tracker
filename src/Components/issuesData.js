export const issues = [
    { issue: "Broken Projector", category: "Maintenance", location: "Science Lab", priority: "High", status: "Pending", reported: "Aug 15" },
    ...
    { issue: "Broken window", category: "Infrastructure", location: "Room 204", priority: "Medium", status: "Pending", reported: "Aug 12" },
    { issue: "Leaking Faucet", category: "Utilities", location: "Faculty Restroom", priority: "Medium", status: "Pending", reported: "Aug 11" },
    { issue: "Broken Electrical Outlet", category: "Maintenance", location: "Room 204", priority: "Critical", status: "Pending", reported: "Aug 9" },
...
export const statusStyles = {
    Pending: "bg-sky-700/10 text-sky-700",
